        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-gray-500">Manajemen File
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <div class="intro-x mt-2 text-gray-500 xl:hidden text-center">UPT Perpustakaan Universitas Lampung
                    </div>
