                                                ...
                                                <table
                                                    ...
                                                    <thead class=" dark:bg-gray-700">
                                                        <tr>
                                                            ...
                                                            <th scope="col"
                                                                class="py-3 px-6 text-xs font-medium tracking-wider text-left text-black uppercase dark:text-gray-400">
                                                                Data
                                                            </th>
                                                    ...
                                                    <tbody
                                                        ...
                                                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                            ...
                                                            @if (empty($user->name))
                                                                <td
                                                                    class="py-4 px-6 text-sm font-medium text-red-500 whitespace-nowrap dark:text-white">
