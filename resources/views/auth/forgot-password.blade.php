                ...
                <div
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button type="submit"
                                class="bg-blue-900 text-white rounded-md py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Reset
                            </button>
                        </div>
                    </form>
...
{{-- <x-guest-layout>
    ...
    <div class="h-screen flex py-5 my-auto xl:my-auto">
        <div
            class="my-auto mx-auto bg-white  xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-96  lg:w-2/4 xl:w">
