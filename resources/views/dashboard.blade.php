                    ...
                    <div id="faq-accordion-1" class="accordion p-5">
                            ...
                            <div id="faq-accordion-content-2" class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <div class="class flex">
                                        ...
                                        <div class="font-medium text-base mt-2 ml-3">Upload dan Edit File Persyaratan
                                        </div>
                                    </div>
                            ...
                            <div id="faq-accordion-collapse-2" class="accordion-collapse collapse"
                                ...
                                <div class="intro-y w-full box">
                                    <div class="mt-5 p-5">
                                        ...
                                        Surat
                                        Layak Uplaod, scan/foto ktm, dan foto pribadi kamu. <br> Jika kamu memerlukan

                                        tanda tangan sebagai <b>Bukti Sebar Karya Akhir</b> bisa dimasukan di form yang
                                        telah
                                ...
                                <div class="intro-y w-full box">
                                    <div class="mt-5 p-5">
                                        ...
                                        <h3 class="py-2">
                                            ...
                                            Kesalahan upload akan diberitahukan oleh admin dan dikirim melaui Email dan
                                            Whatsapp.
                                        </h3>

                                        <h3 class="py-2">
                                            <span class="bg-gray-600 text-white py-1 px-3 rounded-full text-xs">Telah
                                                Diperbaiki</span> Status ini muncul ketika kamu selesai revisi file atau
                        ...
                        <div class="accordion-item mt-3">
                            ...
                            <div id="faq-accordion-collapse-2" class="accordion-collapse collapse"
                                ...
                                <div class="intro-y w-full box">
                                    <div class="mt-5 p-5">
                                        Setelah mendapatkan Akun Digilib. Selanjutnya adalah Menguplaod file skripsi ke
                                        digilib Unila.
