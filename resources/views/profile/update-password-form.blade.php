<x-jet-form-section submit="updatePassword">
    ...
    <x-slot name="description">
        {{ __('Update Password Terlebih Dahulu.') }}
    </x-slot>
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="current_password" type="password" class="mt-1 block w-full"
                wire:model.defer="state.current_password" autocomplete="current-password" class="form-control" />
            <x-jet-input-error for="current_password" class="mt-2" />
        </div>

        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="password" value="{{ __('Password Terbaru') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="password_confirmation" type="password" class="form-control"
    ...
    <x-slot name="actions">
        ...
        <!--      <x-jet-button class="bg-green-600 hover:bg-indigo-600 text-white shadow-sm text-sm font-medium rounded-md text-white py-2 px-4"> -->
        <div class="px-4 py-3 bg-gray-50 text-right sm:px-0">
            <button type="submit"
